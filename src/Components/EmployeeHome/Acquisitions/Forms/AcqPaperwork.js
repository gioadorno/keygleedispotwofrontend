                    ...
                    <Grid container style={{ marginTop: '1em' }} spacing={4}>
                        ...
                        <Grid item xs={12} sm={6} >
                                ...
                                <FormLabel style={{ marginBottom: '1em', color: '#607d8b', fontWeight: '550', textAlign: 'center', width: '100%' }}>Property Type</FormLabel>
                                    <Select label='Property Type' name='propType' value={propertyData.propType} aria-describedby='propType' onChange={e => setPropertyData({ ...propertyData, propType: e.target.value })} style={{ width: '90%', height: '3em' }} variant='outlined'>
                        ...
                        <Grid item xs={12} sm={6} >
                            ...
                            <FormControl style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '3em', borderBottomColor: '#000000de' }}>
                            <FormLabel style={{ marginBottom: '1em', color: '#607d8b', fontWeight: '550', textAlign: 'center', width: '100%' }}>When is COE?</FormLabel>
                                <LocalizationProvider locale={enLocale} dateAdapter={AdapterDateFns}>
                                    <DatePicker name='coe' label="COE" style={{ width: '90%', borderBottomColor: '#000000de' }} value={propertyData.coe} onChange={(newValue) => setPropertyData({ ...propertyData, coe: format(newValue, 'MM/dd/yyyy') })} renderInput={(params) => <TextField variant="outlined" color="primary" style={{ width: '90%', borderBottomColor: '#000000de' }} {...params}/> } />
                        ...
                        <Grid item xs={12} sm={6} >
                            ...
                            <RadioGroup aria-describedby='writeContract' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} onChange={e => setPropertyData({ ...propertyData, writeContract: e.target.value })} row>
                            <FormLabel style={{ marginBottom: '1em', color: '#607d8b', fontWeight: '550', textAlign: 'center', width: '100%' }}>Who is writing the Contract?</FormLabel>
                                <FormControlLabel name="writeContract" value='Us' control={<Radio />} label='Us' />
