...
const TermsAndConditions = () => {
  return (
    <Container sx={{ backgroundColor: 'white', overflowY: 'auto', boxShadow: 3, display: 'flex', width: '90%', flexDirection: 'column', m: 2, height: '100%', alignItems: 'center' }}>
        
    <Typography sx={{ pt: 1 }} variant='h4' component='h4'> KeyGlee Dispo Buyer Portal Terms and Conditions <br/><br/></Typography>
        <Typography sx={{ overflowY: 'hidden' }} variant='body' >
        These terms and conditions create a contract between you and AEM Real Estate Group DBA KeyGlee Dispo (the “Agreement”). Please read the Agreement carefully. To confirm your understanding and acceptance of the Agreement, click “Agree.”<br/><br/>
        </Typography>
        <Typography  variant='h5' component='h5'> Privacy Policy <br/><br/></Typography>
...
When ordering or registering on our site, as appropriate, you may be asked to enter your: name, e-mail address, mailing address or phone number. You may, however, visit our site anonymously. We transfer information about you if KeyGlee is acquired by or merged with another company. In this event, KeyGlee will notify you before information about you is transferred and becomes subject to a different privacy policy.
...
KeyGlee also may use 3rd party vendor re-marketing tracking cookies, including but not limited to the Google Adwords tracking cookie. This means we will continue to show ads to you across the internet, specifically on the Google Content Network (GCN). As always we respect your privacy and are not collecting any identifiable information through the use of Google’s or any other 3rd party remarketing system.
...
This website uses the Google AdWords remarketing service to advertise on third party websites (including Google) to previous visitors to our site. It could mean that we advertise to previous visitors who haven’t completed a task on our site, for example using the contact form to make an inquiry. This could be in the form of an advertisement on the Google search results page or a site in the Google Display Network. Third-party vendors, including Google, use cookies to serve ads based on someone’s past visits to the KeyGlee website. Of course, any data collected will be used in accordance with our own privacy policy and Google’s privacy policy.”
...
If we decide to change our privacy policy, we will post those changes on this page.
        ...
        <Typography sx={{ mb: 2 }} variant='h5' component='h5'> DISCLAIMER: <br/><br/></Typography>
        <Typography variant='body' >
        ALL HOMES LISTED HEREIN ARE EITHER OWNED OR UNDER CONTRACT BY AEM REAL ESTATE GROUP, LLC, DBA KEYGLEE DISPO ("SELLER"). SELLER IS IN THE BUSINESS OF ACQUIRING PROPERTIES AND SELLING WHOLESALE TO INVESTORS, AMONG OTHER REAL ESTATE INVESTING ACTIVITIES. PROPERTIES ARE ACQUIRED THROUGH A VARIETY OF SOURCES.
 
THE PRICES ARE NET TO SELLER.  BUYER PAYS ALL CLOSING/ESCROW COSTS INCLUDING HOA TRANSFER/RESERVES AND ANY OTHER FEES ASSOCIATED WITH THE TRANSFER OF PROPERTY.  PRICES ARE BASED ON QUICK CLOSING OF 10-15 DAYS OR LESS, USING CASH OR A COMBINATION OF CASH AND PRIVATE FINANCING. 
 
ALL PROPERTIES ARE SOLD IN 'AS IS' CONDITION. ARV VALUES ARE ESTIMATES, BUYER TO VERIFY. SELLER MAKES NO WARRANTY OF ANY KIND, EXPRESSED OR IMPLIED, REGARDING THE CONDITION, SQUARE FOOTAGE, INSURABILITY, VERIFICATION OF SEPTIC OR SEWER CONNECTION, STRUCTURAL, PLUMBING, ELECTRICAL OR MECHANICAL SYSTEMS, WELLS, HEATING, AIR CONDITIONING, APPLIANCES, SOIL, FOUNDATION, POOL/SPA, AND RELATED EQUIPMENT, ENVIRONMENTAL HAZARDS (SUCH AS ASBESTOS, FORMALDEHYDE, RADON GAS, LEAD BASED PAINT, FUEL OR CHEMICAL STORAGE TANKS, HAZARDOUS WASTE, LANDFILLS, HIGH VOLTAGE ELECTRICAL LINES, LOCATION NEAR SUPERFUND AREAS, ENDANGERED SPECIES, WATER QUALITY, GEOLOGICAL CONDITIONS), LOCATION OF PROPERTY LINES, WATER/UTILITY USE RESTRICTIONS, FLOOD PLAIN, BUILDING PERMITS OR COMPLIANCE WITH BUILDING CODES, ZONING, THE OCCURRENCE OF DISEASE, DEATH, HOMICIDE, SUICIDE, OR OTHER CRIME IN THE VICINITY OF THE PREMISES.  EVERYTHING, NOT LIMITED TO THE ABOVE REFERENCED ITEMS, IS THE RESPONSIBILITY OF THE BUYER TO INVESTIGATE AND SATISFY TO A LEVEL SUITABLE TO THE BUYER, PRIOR TO SIGNING A CONTRACT TO PURCHASE THE PROPERTY AND/OR DEPOSITING EARNEST MONEY FUNDS. TYPICALLY, SELLER WILL GATHER INFORMATION REGARDING SQUARE FOOTAGE, LOT SIZE, YEAR BUILT, CONDITION, VALUES, ETC FROM THE COUNTY ASSESSOR'S WEBSITE, PUBLIC TAX RECORDS, PRIOR MLS LISTINGS, AND OTHER SOURCES THAT MIGHT BE AVAILABLE. ALTHOUGH THE INFORMATION SHOULD BE ACCURATE, THESE SOURCES HAVE BEEN KNOWN TO PRODUCE WRONG INFORMATION ON OCCASION. SELLER IS NOT HELD LIABLE FOR ANY INFORMATION RELEASED TO THE BUYER FROM ANY SOURCE REFERENCED FOR THE BUYER'S CONVENIENCE.
...
BUYER EXPLICITLY WAIVES CLAIMS AGAINST SELLER, ITS MEMBERS, DIRECTORS, EMPLOYEES, AGENTS, AND INDEPENDENT CONTRACTORS, FOR TORT, FRAUD, MISREPRESENTATION, NEGLIGENCE, AND VIOLATIONS.

KeyGlee and its members, managers, directors, and/or employees DO NOT REPRESENT YOU in any capacity. You should not assume that any real estate broker or associate represents you unless you engage in writing a real estate licensee in an authorized brokerage relationship. You acknowledge and understand that RISK OF LOSS in real estate investing can be substantial, and that real estate investment is, by its nature, SPECULATIVE. You should therefore carefully consider whether such investing is suitable in light of your financial condition. You should not rely on any information provided by KeyGlee as a substitute for the exercise of your own skill and judgment in making a decision on the appropriateness of any real estate investment. By signing below, you acknowledge that you have been advised that KeyGlee and its associates do not represent you and that you may have substantial losses if you invest in real estate. If signing on behalf of an entity, I represent I have the capacity and authority to bind such entity.

You expressly agree that the identities of any individual, entity, and any information relating to a property made available by KeyGlee shall constitute “Confidential Information” and you or any associated entity or individual shall not, within three (3) years from the date hereof: directly or indirectly initiate, solicit, negotiate, contract or enter into any business transactions, agreements or undertakings with any such third party identified or introduced by KeyGlee; or seek to by-pass, compete, avoid or circumvent KeyGlee from any business opportunity by utilizing any Confidential Information or by otherwise exploiting or deriving any benefit from the Confidential Information.
